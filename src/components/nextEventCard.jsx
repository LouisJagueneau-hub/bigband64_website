...
export default function NextEventCard() {
    return (
        <div className="text-white px-8 py-6 border-1 border-white/50 rounded-md sm:w-[370px] flex flex-col relative">
            ...
            <h4 className="text-xl font-poppins font-bold mb-4 text-white/90">BigBand à Nulle Bar Ailleurs</h4>

            <p className="font-poppins text-[0.90rem] text-white/70 flex items-center gap-2 mb-4"><FaCalendar /> 10 Mai 2026</p>


            <a href="https://www.facebook.com/profile.php?id=61551987910890" target="_blank" className="text-primary text-[0.90rem] font-poppins font-semibold flex items-center gap-2">
